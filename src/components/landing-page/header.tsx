...
const Header = () => {
  ...
  return (
    <header className="flex justify-center p-4 items-center ">
      <Link href={"/"} className="w-full flex gap-2 justify-start items-center">
        <Image alt="brainbox logo" width={25} height={25} src={logo} />
        <span className="font-semibold dark:text-white">brainbox.</span>
      </Link>
      ...
      <NavigationMenu className="hidden md:block">
        <NavigationMenuList className="gap-6">
          <NavigationMenuItem>
            <NavigationMenuTrigger
              ...
              className={cn({
                ...
                "dard:text-white/40": path !== "#resources",
                "font-normal": true,
                "text-xl": true,
              })}
            >
          ...
          <NavigationMenuTrigger onClick={() => {}}></NavigationMenuTrigger>
        </NavigationMenuList>
      </NavigationMenu>
    </header>
  );
    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ...
          {...props}
        >
          <div className="text-white text-sm font-medium leadin-none ">
            {title}
          </div>
